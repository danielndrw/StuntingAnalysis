...
# ======================
# Page 2: Klasifikasi Sehat vs Tidak Sehat (k=3, tanpa metrik)
# ======================
    ...
    mean_score = dfc.groupby('Cluster')['Skor_Sejahtera'].mean().sort_values(ascending=False)
    order = list(mean_score.index)  # urut sehat → sedang → tidak sehat
    ...
    dfc['Kategori'] = dfc['Cluster'].map(label_map)
